...
int main() {
    ...
    int arrayCount = countOCarr(data, max_size, key);

    std::cout << "Array occurrences: "<< arrayCount<< "\n";

    // Count occurrences in the linked list.
    int listCount = countOCll(head, key);

    std::cout << "Linked List occurrences: "<< listCount<< "\n";
    return 0;
